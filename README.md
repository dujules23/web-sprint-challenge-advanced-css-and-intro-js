...
1. How would you describe acessibility on the web to someone new to programming?
    ...
    <!-- Accessibilty refers to a website's flexibilty in regard the ability to look presentable on mulitiple devices (phones, tablet, desktop). -->
2. Talk about 3 different things you can do to ensure your website is accessible. 
   <!-- You can make sure color palletes are approriate, you can make sure the site is accessbile for impaired people, and we can structure the content using semantic tags so they are read by browsers most efficiently. -->

3. How would you explain the concept of a variable to someone new to programming?

    <!-- A variable is essentially a storage container in which you can store data and recall the data to be used in your code. -->
